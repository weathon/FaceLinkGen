...
#     else:
#         param.requires_grad = False #main code has this???? no wonder it is a bit off
...
# paths = paths[:100] * 20
paths = random.sample(paths, min(256, len(paths))) * 5
...
loader = DataLoader(dataset, batch_size=64, shuffle=True, num_workers=32, pin_memory=True)
...
for e in range(epochs):
    ...
    torch.save(student.state_dict(), "student_mini.pth")
