...
if os.path.exists("vgg_student.pth"):
    ...
    wandb.init(project="student_distill", resume="must", id="7mvhmsnw")
...
def cosine_triplet(a, p, n, margin=0.1):
...
loader = DataLoader(dataset, batch_size=256 + 128, shuffle=True, num_workers=32, pin_memory=True)
...
for e in range(epochs):
    ...
    count = 0
    total_mae = 0
    for t_img, conv_raw in tqdm.tqdm(loader):
    ...
    torch.save(student.state_dict(), "vgg_student.pth")
