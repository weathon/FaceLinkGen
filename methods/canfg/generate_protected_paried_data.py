...
valid_dataset = CelebA_test("../fairface", "../fairface", k=len(os.listdir("../fairface/")))
...
if not os.path.exists('data/'+dataset+'/fairface/'):
    os.makedirs('data/'+dataset+'/fairface/')
if not os.path.exists('data/'+dataset+'/fairface_A/'):
    os.makedirs('data/'+dataset+'/fairface_A/')
...
with torch.no_grad():
    iter=0
    for img_1,img_2,name in tqdm.tqdm(valid_dataloader):
        ...
        # names=name[0]
        filename1='data/'+dataset+'/fairface/'+names
        filename2 = 'data/'+dataset+'/fairface_A/'+ names
        print(filename1)
