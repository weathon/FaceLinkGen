...
def IR_18(input_size, input_channel=81, **kwargs):
    """ Constructs a ir-18 model. """
    model = Backbone(input_size, 18, 'ir', input_channel=input_channel, **kwargs)
    return model
...
def IR_50(input_size, input_channel=81, **kwargs):
    """ Constructs a ir-50 model. """
    model = Backbone(input_size, 50, 'ir', input_channel=input_channel, **kwargs)
    return model
